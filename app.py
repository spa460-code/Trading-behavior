...
# Ensure tables exist however the app is launched.
# (Under gunicorn on Render the __main__ block below never runs, so we
#  must initialise the database here, at import time.)
init_db()
